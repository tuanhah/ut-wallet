...
import { Address, HotWallet, InternalTransfer, WalletBalance, Withdrawal, Wallet } from '../entities';
import * as rawdb from '../rawdb';

const logger = getLogger('processOneDepositTransactionAnAddress');

/**
 * Process one deposit transaction
 */
export async function processOneDepositTransactionAnAddress(
...
export default processOneDepositTransactionAnAddress;
